...
@property (nonatomic,strong) MSCollectionViewFlowLayout *flowLayout;
...
+(instancetype)cycleScrollViewWithFrame:(CGRect)frame shouldInfiniteLoop:(BOOL)infiniteLoop imageGroups:(NSMutableArray *)imageGroups
{
...
{
    MSHomModel * homeModel = _imgArr[indexPath.row];
...
-(MSCollectionViewFlowLayout *)flowLayout
{
    if(_flowLayout == nil)
    {
        _flowLayout = [[MSCollectionViewFlowLayout alloc]init];

...
//手机号有效性
- (BOOL)isMobileNumber{
    NSString *mobileRegex = @"^(0|86|17951)?(13[0-9]|15[012356789]|17[05678]|18[0-9]|14[57])[0-9]{8}$";
...
//    //文件的属性
//    NSDictionary *attris = [mgr attributesOfItemAtPath:self error:nil];
//    if ([attris.fileType isEqualToString:NSFileTypeDirectory]) {//文件夹
//        NSDirectoryEnumerator *enumers = [mgr enumeratorAtPath:self];
//        for (NSString *subpath  in enumers) {
//            NSString * fullPath = [self stringByAppendingPathComponent:subpath];
//            NSDictionary * attris = [mgr attributesOfItemAtPath:fullPath error:nil];
//            size += attris.fileSize;
//        }
//    }else{//文件
//        size = attris.fileSize;
//
...
+(CGFloat)textF:(NSString *)text textSizeW:(CGFloat)maxW textFont:(CGFloat)textFont{
    
    // 文字的最大尺寸
    CGSize maxSize = CGSizeMake(maxW, MAXFLOAT);
    // 计算文字的高度
    CGFloat textH = [text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:textFont]} context:nil].size.height;
    
    return textH;
    
    
}
+(CGFloat)textF:(NSString *)text textSizeH:(CGFloat)maxH textFont:(CGFloat)textFont{
    
    // 文字的最大尺寸
    CGSize maxSize = CGSizeMake(MAXFLOAT, maxH);
    // 计算文字的高度
    CGFloat textW = [text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:textFont]} context:nil].size.width;
    
    return textW;
    
    
}
-(CGFloat)textSizeH:(CGFloat)maxH textFont:(CGFloat)textFont{
    
    // 文字的最大尺寸
    CGSize maxSize = CGSizeMake(MAXFLOAT, maxH);
    // 计算文字的高度
    CGFloat textW = [self boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:textFont]} context:nil].size.width;
    
    return textW;
}
-(CGFloat)textSizeW:(CGFloat)maxW textFont:(CGFloat)textFont{
    // 文字的最大尺寸
    CGSize maxSize = CGSizeMake(maxW, MAXFLOAT);
    // 计算文字的高度
    CGFloat textH = [self boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:textFont]} context:nil].size.height;
